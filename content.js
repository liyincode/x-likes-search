...
(() => {
  ...
  async function syncLikes() {
    ...
    if (!capturedTemplate) {
      setStatus("No request captured yet. Reload the likes page (or scroll a bit), then click Sync again.");
      // Try to nudge X to make a request:
    ...
    try {
      ...
      setStatus("Bad captured URL — refresh the likes page and try again.");
      syncing = false;
      return;
    }
