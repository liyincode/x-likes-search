// Classic-script sync engine during the staged ESM migration.
// The temporary XLSSync global is removed by the atomic module cutover.

((root) => {
  function createSyncEngine(dependencies) {
